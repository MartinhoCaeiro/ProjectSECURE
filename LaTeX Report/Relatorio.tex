...
\begin{itemize}
	\item Problemas de compatibilidade entre tipos de base de dados (SQLite e Schemas);
	      \begin{itemize}
		      \item Incompatibilidade de nomes entre tabela;
		      \item Configurações por defeito diferentes entre as plataformas;
	      \end{itemize}
	\item Sincronização de dados entre dispositivos/sistemas operativos;
...
\begin{figure}[htb]
    ...
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{Recursos/WiresharkEncriptada.png}
        \caption{Com Criptografia}
        \label{fig:img2}
    \end{subfigure}
